              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="90" class="text-center">
                    <div>
                      <!-- tombol edit profil -->
                      <a href="?module=form_edit_profil&id=<?php echo $data['id_user']; ?>" class="btn btn-icon btn-round btn-info btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Edit">
