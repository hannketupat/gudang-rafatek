<?php
  ...
  ?>
    ...
    <div class="page-inner mt--5">
      ...
      <!-- menampilkan informasi stok barang yang memiliki stok tersedia -->
      <div class="card">
        <div class="card-header">
          <!-- judul tabel -->
          <div class="card-title"><i class="fas fa-boxes mr-2"></i> Stok barang tersedia</div>
        </div>
        <div class="card-body">
    ...
    <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
      <thead>
        <tr>
          ...
          <th class="text-center">Foto</th> <!-- Tambahan -->
      ...
      <tbody>
        <?php
        $no = 1;
    $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.serial_number, a.jenis, a.stok_minimum, a.stok, a.satuan, a.foto, 
                ...
                ORDER BY a.stok DESC, a.id_barang ASC")
          ...
          <tr>
            ...
            <td width="80" class="text-center">
              <?php if (!empty($data['foto'])) { ?>
                <img src="images/<?php echo $data['foto']; ?>" alt="<?php echo $data['nama_barang']; ?>" width="60" height="60" style="object-fit:cover; border-radius:8px;">
              <?php } else { ?>
                <span class="badge badge-secondary">No Image</span>
              <?php } ?>
            </td>
            <td width="150" class="text-center">
              <?php if (strtoupper($data['nama_jenis']) == 'MODEM' && !empty($data['serial_number'])) { ?>
                <?php echo $data['serial_number']; ?><br>
                <img src="libs/barcode.php?text=<?php echo urlencode($data['serial_number']); ?>&codetype=code128&size=30&print=true" alt="Barcode <?php echo htmlspecialchars($data['serial_number']); ?>">
              <?php } else { ?>
                <?php echo $data['id_barang']; ?><br>
                <img src="libs/barcode.php?text=<?php echo urlencode($data['id_barang']); ?>&codetype=code128&size=30&print=true" alt="Barcode <?php echo htmlspecialchars($data['id_barang']); ?>">
              <?php } ?>
            </td>
            <td width="200"><?php echo $data['nama_barang']; ?></td>
            <td width="150"><?php echo $data['nama_jenis']; ?></td>
            <td width="70" class="text-right"><span class="badge badge-success"><?php echo $data['stok']; ?></span></td>
