      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body text-center">
            ...
            if (is_null($data['foto']) || empty($data['foto'])) { ?>
            ...
            // jika data "foto" ada di database
              ...
              if (file_exists($absolute_path)) { ?>
                ...
                <img style="max-height:375px" src="<?php echo $relative_path; ?>" class="img-fluid" alt="Foto Barang">
              <?php } else { ?>
                <!-- tampilkan foto default jika file tidak ditemukan -->
                <img style="max-height:375px" src="images/no_image.png" class="img-fluid" alt="Foto Barang">
                <div class="mt-2">
                  <small class="text-muted">Foto tidak ditemukan: <?php echo htmlspecialchars($data['foto']); ?></small>
                </div>
              <?php }
            } ?>
          </div>
