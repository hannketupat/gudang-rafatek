...
<body class="login">
  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Username/Email atau Password salah. Cek kembali Username/Email dan Password Anda.</span>
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      <!-- logo -->
      <div class="text-center mb-4"><img src="assets/img/logo.jpg" alt="Logo" width="95px"></div>
      <!-- judul -->
      ...
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        <div class="form-group form-floating-label">
          ...
          <label for="username" class="placeholder">Username atau Email</label>
