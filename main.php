...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/css/atlantis.min.css?v=<?php echo time(); ?>">
  ...
  <div class="navbar-brand">
    <span>
      <img src="assets/img/logo.jpg" alt="Logo" style="height:25px; margin-left:5px;">
    </span>
    <span class="text-white brand-text" style="display:inline-block; font-size:14px;">Gudang RAFATEK</span>
              ...
              <li class="nav-item dropdown hidden-caret">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0)" aria-expanded="false">
                  <div class="avatar-sm-top mt-1">
                    <?php
                    // tentukan foto yang akan ditampilkan di header
                    if (!empty($_SESSION['foto_profil']) && file_exists('assets/img/profiles/' . $_SESSION['foto_profil'])) {
                      $foto_header = 'assets/img/profiles/' . $_SESSION['foto_profil'];
                    } else {
                      $foto_header = 'assets/img/avatar-1.png';
                    }
                    ?>
                    <img src="<?php echo $foto_header; ?>" alt="image profile" class="avatar-img rounded-circle">
                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                  <li>
                    <div class="user-box">
                      <?php
                      // tentukan foto yang akan ditampilkan di dropdown
                      if (!empty($_SESSION['foto_profil']) && file_exists('assets/img/profiles/' . $_SESSION['foto_profil'])) {
                        $foto_dropdown = 'assets/img/profiles/' . $_SESSION['foto_profil'];
                      } else {
                        $foto_dropdown = 'assets/img/avatar-2.png';
                      }
                      ?>
                      <div class="avatar-lg"><img src="<?php echo $foto_dropdown; ?>" alt="image profile" class="avatar-img rounded"></div>
                  ...
                  <li>
                    ...
                    <a class="dropdown-item" href="?module=form_edit_profil">
          ...
          <div class="sidebar-content">
            ...
            <div class="user">
              <div class="avatar-sm float-left mr-2">
                <?php
                // tentukan foto yang akan ditampilkan di sidebar
                if (!empty($_SESSION['foto_profil']) && file_exists('assets/img/profiles/' . $_SESSION['foto_profil'])) {
                  $foto_sidebar = 'assets/img/profiles/' . $_SESSION['foto_profil'];
                } else {
                  $foto_sidebar = 'assets/img/avatar-2.png';
                }
                ?>
                <img src="<?php echo $foto_sidebar; ?>" alt="image profile" class="avatar-img rounded-circle">
              </div>
              <div class="info">
                <a>
                  <span>
